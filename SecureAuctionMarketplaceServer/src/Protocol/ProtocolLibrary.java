...
public class ProtocolLibrary {
	...
	/**
	 * Change a byte array to an Object
	 * 
	 * @param bytes
	 * 		
	 * @return
	 * @throws Exception 
	 * 		The exception during convertion
	 */
	public static Object toObject (byte[] bytes) throws Exception
	{
	  ...
	  try {
	    ...
	    //TODO: Handle the exception
		  throw new Exception("Cannot deserialize the corresponding class for the byte array");
	  }
	  return obj;
	}
	
	/**
	 * A public method that changes a serializable obj to an byte array
	 * 
	 * @param obj
	 * 		obj that implements the Serializable interface
	 * @return
